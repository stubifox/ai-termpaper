...
def to_1d_lambda(Puzzle): return [elem for tupl in Puzzle for elem in tupl]
...
assert get_permutation_count_recursive(
    start1['data']) == get_permutation_count(start1['data'])
